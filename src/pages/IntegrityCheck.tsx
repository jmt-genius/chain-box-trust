              ...
              <GlassCard className="p-6">
                <div className="text-center">
                  ...
                  <div className="relative inline-block mb-6">
                    <div className="w-32 h-32 rounded-full border-8 border-secondary/20 flex items-center justify-center">
                      <svg
                        className="w-32 h-32 absolute inset-0 transform -rotate-90"
                        viewBox="0 0 120 120"
                      >
                        <circle
                          cx="60"
                      ...
                      <div
                        className={`w-28 h-28 rounded-full flex items-center justify-center text-3xl font-bold ${
                          trustScore.aggregate_tis >= 80
                            ? "bg-green-500/20 text-green-400 border-4 border-green-500/30"
                            : trustScore.aggregate_tis >= 40
                            ? "bg-orange-500/20 text-orange-400 border-4 border-orange-500/30"
